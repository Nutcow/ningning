(function initGoogleSearch() {
    ...
    const GOOGLE_SEARCH_DB = [
        ...
        {
            id: 'mingan2zx',
            matched: ['明安二中', '二中', '2018届', '明安2中', '明安市第二中学'],
            results: [
                {
                    title: '明安市第二中学 - 2018届毕业生名单公示',
                    url: 'mingan2zx.edu.xyzz/graduates/2021',
                    displayUrl: 'mingan2zx.edu.xyzz › graduates › 2021',
                    desc: '明安二中2018届毕业生名单（三班）。其中三班 第17号 学生信息显示：【该条记录已注销】。如对名单有疑问，请联系教务处核实。',
                    favicon: 'map'
                },
                {
                    ...
                    desc: '楼主：今天翻看同学录的时候，发现有张椅子的照片，这椅子有什么特别之处吗？1L：可能是忘记换照片了？2L：这错误也太低级了吧。',
                    favicon: 'baidu'
                }
            ]
        }
